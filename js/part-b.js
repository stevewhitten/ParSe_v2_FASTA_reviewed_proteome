    ...
    options = {
        ...
        summary: {
            ...
            columns: [
                ...
                {
                    title: 'first residue of longest non-PS IDR',
                    field: 'd_start',
                    sorter: 'number',
                },
                {
                    title: 'last residue of longest non-PS IDR',
                    field: 'd_end',
                    sorter: 'number',
                },
                {
                    title: 'Σ classifier distance F',
                    field: 'f_sum',
                    sorter: 'number',
                },
                {
                ...
                {
                    title: 'first residue of longest F-labeled region',
                    field: 'f_start',
                    sorter: 'number',
                },
                {
                    title: 'last residue of longest F-labeled region',
                    field: 'f_end',
                    sorter: 'number',
                },
                {
    ...
    displaySummary(proteins) {
        ...
        proteins.forEach((x, i) => {
            ...
            data.push({
                ...
                p_end: longest.P.end,
                d_sum: x.residues.filter(x => x.region == 'D').reduce((a, c) => a + c.dist_norm, 0).toFixed(1),
                longest_nonPS_IDR: longest.D.length,
                d_start: longest.D.start,
                d_end: longest.D.end,
                f_sum: x.residues.filter(x => x.region == 'F').reduce((a, c) => a + c.dist_norm, 0).toFixed(1),
